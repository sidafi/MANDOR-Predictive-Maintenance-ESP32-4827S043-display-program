...
void ui_Screen6_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Label5, -126);
    lv_obj_set_y(ui_Label5, 5);
    lv_obj_set_align(ui_Label5, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label5, "28mm/s");
    ...
    lv_obj_set_y(ui_Button4, 105);
    lv_obj_set_align(ui_Button4, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Button4, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_remove_flag(ui_Button4, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_Button4, lv_color_hex(0xEB3131), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(ui_Label41, 81);
    lv_obj_set_align(ui_Label41, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label41, "Status");
    ...
    lv_obj_set_x(ui_Label42, -4);
    lv_obj_set_y(ui_Label42, -89);
    lv_obj_set_align(ui_Label42, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label42, "Vibration");

    ui_Button14 = lv_button_create(ui_Screen6);
    lv_obj_set_width(ui_Button14, 100);
    lv_obj_set_height(ui_Button14, 32);
    lv_obj_set_x(ui_Button14, -166);
    ...
    lv_obj_set_y(ui_Label43, 112);
    lv_obj_set_align(ui_Label43, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label43, "Kembali");
